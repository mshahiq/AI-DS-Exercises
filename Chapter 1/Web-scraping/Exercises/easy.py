...
def web_scrapping():
    ...
    for day_discription in range(3,13,2):
    ...
    for night_discription in range(4,14,2):
...
############################### MAKING THE DF ################################################################################################
    ...
    dates_from_08 = pd.date_range('2022-02-09',periods=5,freq='D')
