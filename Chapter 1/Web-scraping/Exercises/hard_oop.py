...
class web_extraction_weather:

    def temperature_conversion(self,Fahrenheit):
        self.Fahrenheit = Fahrenheit
        temperature_in_celsius = (self.Fahrenheit - 32) * (5/9)
        return round(temperature_in_celsius,1)


    def web_extraction(self,forecast_for):

        self.forecast_for =forecast_for
        ...
        for i in range(1,self.forecast_for+1):
            ...
            day_temperature_in_C = self.temperature_conversion(int_day_temperature)
            ...
            night_temperature_in_C = self.temperature_conversion(int_night_temperature)
    ...
    #########################################       SAVING IT INTO PANDAS DATAFRAME        #######################################################################
        ...
        dates_from_08 = pd.date_range('2022-02-08',periods=forecast_for,freq='D')

        df = pd.DataFrame(data,index = dates_from_08).rename_axis('Date',axis=1)
        return df


Object = web_extraction_weather()

print(Object.web_extraction(4))
